...
/* Window : scrollTo */ // innisfree-clone-coding 1차 과제 참고
const toTopEl = document.querySelector(".go-top");
window.addEventListener("scroll", _.throttle(function() {
    if (window.scrollY > 300) gsap.to(toTopEl, 0.2, {
        y: 0
    });
    else gsap.to(toTopEl, 0.2, {
        y: 100
    });
}, 300));
...
/* Swiper : Pagination & Navigation */ // https://swiperjs.com/swiper-api#pagination api 참고
...
},{}]},["9tRox","1SICI"], "1SICI", "parcelRequirecd0d")
